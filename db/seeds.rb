...
user_1 = User.create!(first_name: 'Marion',last_name: 'Henrio',email: "marion.henrio@gmail.com",id: 1, restaurant: restaurant_12, menu_released: false, password: 'secret', admin: true, phone_number: '06.20.89.65.89')
...
user_2 = User.create!(first_name: 'Gauthier',last_name: 'Taton',email: "gauthier_taton@yahoo.fr",id: 2, restaurant: restaurant_12, menu_released: false, password: 'secret', admin: true, phone_number: '06.20.40.14.84')
...
user_3 = User.create!(first_name: 'Armel',last_name: 'Ahehehinnou',email: "ahehehinnouarmel8@gmail.com",id: 3, restaurant: restaurant_7, menu_released: false, password: 'secret', phone_number: '06.80.50.24.81')
...
user_4 = User.create!(first_name: 'Justine',last_name: 'Barbault',email: "justinehsd@gmail.com",id: 4, restaurant: restaurant_6, menu_released: false, password: 'secret', phone_number: '06.24.48.74.14')
...
user_5 = User.create!(first_name: 'David',last_name: 'Lorenz',email: "devid.lorenz@gmail.com",id: 5, restaurant: restaurant_12, menu_released: false, password: 'secret', phone_number: '06.31.24.38.74')
...
user_6 = User.create!(first_name: 'Camille',last_name: 'Paturel',email: "camille_paturel@yahoo.fr",id: 6, restaurant: restaurant_12, menu_released: false, password: 'secret', phone_number: '06.00.92.44.04')
...
user_7 = User.create!(first_name: 'Corentin',last_name: 'Dubois',email: "corentindubois@gmail.com",id: 7, restaurant: restaurant_12, menu_released: false, password: 'secret', phone_number: '06.11.99.29.64')
...
user_8 = User.create!(first_name: 'Sophia',last_name: 'Rissot',email: "sophiarissot@gmail.com",id: 8, restaurant: restaurant_12, menu_released: false, password: 'secret', phone_number: '06.22.78.12.45')
